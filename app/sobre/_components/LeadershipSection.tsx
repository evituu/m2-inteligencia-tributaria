        ...
        <div className="relative mx-auto mb-14 max-w-[680px]">
          ...
          >
            <div className="relative aspect-[3/4] w-full overflow-hidden rounded-md md:rounded-lg">
              <Image
                src="/imagens/office/veimar_nuccia_g4.jpeg"
        ...
        <div className="grid gap-6 md:grid-cols-2 md:items-stretch">
          {leaders.map((leader, index) => (
            <SlideIn
              ...
              className="h-full"
            >
              <article className="flex h-full flex-col border-l-4 border-[#f2c40f] bg-white/[0.04] px-6 py-7 transition-transform duration-300 hover:-translate-y-1 md:px-8 md:py-9">
