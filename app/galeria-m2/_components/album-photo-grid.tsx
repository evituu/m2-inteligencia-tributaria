      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        {photos.map((photo, index) => (
          <button
            ...
            className={`group relative cursor-pointer overflow-hidden rounded-sm border border-zinc-700/40 bg-zinc-900 text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-[#f2c40f] focus-visible:ring-offset-2 focus-visible:ring-offset-[#05090c] ${layoutClasses(photo.layout)}`}
          >
            <Image
              src={photo.src}
              alt={photo.alt}
