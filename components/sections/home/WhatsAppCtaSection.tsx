  ...
  return (
    <section className="relative overflow-hidden bg-white py-14 md:py-20">
      ...
      <div className="relative mx-auto flex w-full max-w-[960px] flex-col items-center gap-6 px-5 text-center md:px-8">
        <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#25D366]/10 ring-2 ring-[#25D366]/40">
          <AiOutlineWhatsApp className="h-9 w-9 text-[#25D366]" />
        </div>

        <h2 className="text-3xl font-black uppercase leading-tight tracking-tight text-[#12151b] md:text-4xl">
          Fale{" "}
          <span className="text-[#c9a227]">diretamente</span>{" "}
          com a nossa{" "}
          <span className="text-[#c9a227]">equipe</span>
        </h2>

        <p className="max-w-[600px] text-base leading-relaxed text-zinc-500 md:text-lg">
          Tire suas dúvidas,
          ou entenda como podemos ajudar a sua empresa de forma{" "}
          <span className="font-semibold text-[#12151b]">rápida e sem burocracia.</span>
        </p>
